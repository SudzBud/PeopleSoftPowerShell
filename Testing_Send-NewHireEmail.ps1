#REGION Send-NewHireMail

$ScriptDir = { Split-Path $MyInvocation.ScriptName –Parent }
$MailFrom = "exchangeadmin@kurtsalmon.com"
$PSEmailServer = "172.16.3.40"
$UserFullname = $userobj.givenname + " " + $userobj.surname
$messageRecips = "Porter, Bud <bud.porter@kurtsalmon.com>"

#$MessageFile = "$scrPath\MessageBody.html"
#[string]$Info = Get-Content $MessageFile

$NewHireMessageSubject = "New Hire / NT Account Created - $UserFullname"
$body = @"
<!DOCTYPE html>
<html>
<body style="font-family:arial;">
<p style="font-weight:bold;">$UserFullname</p>
<p>$UserFullname</p>
<p></p>
<p>$messageRecips</p>
</body>
...
"@
	[string]$hlpBody = $($ExpireSoon | Select-Object Name,Expires,passwordIsExpired,Expiration) | Sort-Object Expires | ConvertTo-Html -head $head


#ENDREGION Send-NewHireMail

# SIG # Begin signature block
# MIINxQYJKoZIhvcNAQcCoIINtjCCDbICAQExCzAJBgUrDgMCGgUAMGkGCisGAQQB
# gjcCAQSgWzBZMDQGCisGAQQBgjcCAR4wJgIDAQAABBAfzDtgWUsITrck0sYpfvNR
# AgEAAgEAAgEAAgEAAgEAMCEwCQYFKw4DAhoFAAQUixst777fD0tSqQ/wfO2Wkmy1
# zomgggu5MIIFoDCCBIigAwIBAgIKRJHmZwAAAAAg7TANBgkqhkiG9w0BAQUFADBI
...
# FgQU9a4eNhupl56BUKNJw0JJyZqK2REwDQYJKoZIhvcNAQEBBQAEgYBpEaDoIXqg
# Mv31w96Kwz1RVwkeABUxxFkzj+afIECMAcA6Ezu9o1UreCakn7jeMXuuXKtlvrUp
# Hiv02HJV4SJT5tFZ95RF90enGj71XOXMZTqb8otMpVawP4Pi3NEvn/4EqvxY+ccv
# kCUHmB8fjc1szTr/CD7IWCTNCpUYegnglA==
